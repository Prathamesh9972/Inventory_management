          ...
          {user ? (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:bg-yellow-100 transition duration-300 cursor-pointer" onClick={() => handleNavigation('/staff/chemicals')}>
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:bg-yellow-100 transition duration-300 cursor-pointer" onClick={() => handleNavigation('/staff/purchases')}>
                  <div className="flex items-center justify-center text-4xl mb-4 text-yellow-600">
